...
class Admin_Employee_Salary_Table extends JPanel
{
    Admin_Employee_Salary_Table()
    {

        JPanel column = new JPanel();
        JLabel Position = new JLabel("Position",JLabel.CENTER);
        JLabel Total_Empolyee = new JLabel("Hourly Salary",JLabel.CENTER);
        JLabel Current = new JLabel("Monthely Salary",JLabel.CENTER);
        JLabel Required = new JLabel("Yearly Salary",JLabel.CENTER);
